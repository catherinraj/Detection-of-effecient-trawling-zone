...
col = ['Column1', 'Column2', 'Column3', 'Column4', 'Column5', 'Column6', 'Column7', 'Label']

# Map the 'Label' column to 1s and 0s
td['Label'] = td['Label'].map({'PFZ': 1, 'NPFZ': 0})

# Define the input features X and target variable y
X = td[col[:-1]]  # all columns except the last ('Label')
y = td[col[-1]]   # just the 'Label' column
